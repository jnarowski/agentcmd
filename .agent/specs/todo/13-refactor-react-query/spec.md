...
<!-- prettier-ignore -->
- [ ] 1.1 [2/10] Create handleMutationError utility
...
- [ ] 1.2 [4/10] Create react-query-patterns.md documentation
...
- [ ] 2.3 [4/10] Extract sessionKeys and slashCommandKeys
...
- [ ] 2.4 [4/10] Extract gitKeys from useGitOperations.ts
...
- [ ] 2.7 [5/10] Update 6 hook files to import from queryKeys.ts
...
- [ ] 2.8 [7/10] Verify all query key factories compile and work
...
<!-- prettier-ignore -->
- [ ] 3.1 [4/10] Create useProjectSpecs hook
...
- [ ] 3.2 [4/10] Create useProjectBranches hook
...
- [ ] 3.3 [4/10] Create useSessionFile hook
...
- [ ] 3.4 [3/10] Update NewRunDialog to use extracted hooks
...
- [ ] 3.5 [3/10] Update SessionFileViewer to use extracted hook
...
- [ ] 4.2 [3/10] Update useWorkflowDefinition.ts
  - Import workflowKeys
...
- [ ] 4.3 [6/10] Update useWorkflowRuns.ts and FIX filter bug
  - Import workflowKeys
...
- [ ] 4.4 [4/10] Update useWorkflowRun.ts
  - Import workflowKeys
...
- [ ] 4.5 [5/10] Update useWorkflowMutations.ts (6 invalidations)
  - Import workflowKeys
...
- [ ] 4.6 [4/10] Update useArchiveWorkflowDefinition.ts - fix over-invalidation
  - Import workflowKeys
...
- [ ] 4.7 [4/10] Update useUnarchiveWorkflowDefinition.ts - fix over-invalidation
  - Import workflowKeys
  - Replace line 25: `workflowKeys.definitionsList(projectId)` (specify projectId, not all)
  - File: `apps/app/src/client/pages/projects/workflows/hooks/useUnarchiveWorkflowDefinition.ts`

- [ ] 4.8 [6/10] Update useWorkflowWebSocket.ts (8+ inline keys)
  - Import workflowKeys
  - Replace all inline keys with factory calls:
...
- [ ] 4.9 [3/10] Update WorkflowOnboardingDialog.tsx
  - Import workflowKeys
...
- [ ] 4.10 [3/10] Update NavActivities.tsx
...
- [ ] 4.11 [4/10] Update ProtectedLayout.tsx
...
<!-- prettier-ignore -->
- [ ] 5.1 [6/10] DELETE useInngestRunStatus.ts
  - Remove file entirely (WebSocket handles updates)
  - Update any imports that reference this hook
  - File: `apps/app/src/client/pages/projects/workflows/hooks/useInngestRunStatus.ts`
  - Verify no remaining references

- [ ] 5.2 [4/10] Remove refetchInterval from useGitStatus
...
- [ ] 5.3 [5/10] Remove custom staleTime from useSettings
...
- [ ] 5.4 [4/10] Remove custom staleTime from useProjectsWithSessions
  - Remove line 130: `staleTime: 30_000`
  - Remove redundant `refetchOnWindowFocus: false`
  - File: `apps/app/src/client/pages/projects/hooks/useProjects.ts`

- [ ] 5.5 [4/10] Remove custom staleTime from useSyncProjects
  - Remove staleTime: 5min
  - Remove redundant `refetchOnWindowFocus: false`
  - File: `apps/app/src/client/pages/projects/hooks/useProjects.ts`

- [ ] 5.6 [4/10] Remove custom staleTime from session hooks
...
- [ ] 5.7 [5/10] Remove custom staleTime from useSlashCommands
...
<!-- prettier-ignore -->
- [ ] 6.1 [3/10] Update useWorkflowMutations error handling
  - Import handleMutationError
  - Replace onError handlers with: `(error) => handleMutationError(error, "context")`
  - File: `apps/app/src/client/pages/projects/workflows/hooks/useWorkflowMutations.ts`

- [ ] 6.2 [3/10] Update useArchive/UnarchiveWorkflowDefinition error handling
  - Import handleMutationError
  - Apply to both archive and unarchive mutations
  - Files: useArchiveWorkflowDefinition.ts, useUnarchiveWorkflowDefinition.ts

- [ ] 6.3 [3/10] Review and standardize useProjects mutations
  - Most already have good error handlers (toast.error)
  - Update any inconsistent patterns to use handleMutationError
  - File: `apps/app/src/client/pages/projects/hooks/useProjects.ts`

- [ ] 6.4 [3/10] Review and standardize useAgentSessions mutations
  - Update any inconsistent error patterns
  - File: `apps/app/src/client/pages/projects/sessions/hooks/useAgentSessions.ts`

- [ ] 6.5 [3/10] Review and standardize useGitOperations mutations
  - Update any inconsistent error patterns (14 mutations)
  - File: `apps/app/src/client/pages/projects/git/hooks/useGitOperations.ts`

- [ ] 6.6 [3/10] Verify all mutations use consistent error handling
  - Search for `useMutation` across codebase
  - Ensure all have standardized error handlers
  - Run: `pnpm check-types`
