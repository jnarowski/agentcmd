...
export function SessionHeader({ session }: SessionHeaderProps) {
  ...
  return (
    <div className="sticky top-[52px] z-10 h-10 flex items-center justify-between gap-1.5 px-4 md:px-6 py-1.5 text-sm text-muted-foreground bg-muted/30 border-b">
