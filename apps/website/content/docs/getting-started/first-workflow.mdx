...
description: Build a simple workflow from scratch in 10 lines
---
...
<Steps>
  ...
  <Step>
    ...
    Navigate to your project at http://localhost:5173
  </Step>
...
<Cards>
  <Card title="Add Phases" href="/docs/concepts/phases">
    Organize steps into logical stages (setup → build → deploy)
  </Card>
  <Card title="Use AI Agents" href="/docs/reference/steps/agent">
    Run Claude/Codex/Gemini with step.agent()
  </Card>
  <Card title="Type-Safe Args" href="/docs/guides/type-safe-arguments">
    Define workflow arguments with schema validation
  </Card>
...
[View Complete Step Reference](/docs/reference/steps)
...
[See Building Workflows Guide](/docs/guides/workflow-definition)
