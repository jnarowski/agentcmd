...
<Steps>
  ...
  <Step>
    ...
    ```bash
    export VITE_WS_HOST=your-machine-name.tail-scale-name.ts.net:4100
    npx agentcmd start
    ```
  ...
  <Step>
    ...
    ```
    http://your-machine-name.tail-scale-name.ts.net:4100
    ```
...
```bash
ssh -L 4100:localhost:4100 your-dev-machine
```

Then access `http://localhost:4100` on your local machine.
