...
See [Planning Sessions](/docs/concepts/planning-sessions) for using agent sessions to create specs.
...
- [Agent Step Reference](/docs/reference/steps/agent) - Complete API
- [Multi-Agent Workflows](/docs/examples/advanced/multi-agent-workflows) - Advanced patterns
