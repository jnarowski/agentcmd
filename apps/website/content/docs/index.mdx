...
```
Web App ↔ Workflow Definitions → Inngest → AI Agents (Claude/Codex/Gemini)
   ↓           ↓                     ↓            ↓
  UI      TypeScript files      Durable       File edits,
         (.agent/workflows/)    execution     commits, PRs
```
...
<Cards>
  ...
  <Card title="Planning Sessions" href="/docs/concepts/planning-sessions">
    Read-only AI exploration that generates specs
  </Card>
