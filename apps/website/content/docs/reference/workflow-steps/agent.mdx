...
- See [MCP example](#with-mcp-servers) below
...
Enable [Model Context Protocol (MCP)](https://modelcontextprotocol.io/) servers to extend agent capabilities with custom tools and resources:
...
<Cards>
  <Card title="Recursive Workflows" href="/docs/examples/recursive-implement-review">
  ...
  <Card title="AI Step" href="/docs/reference/workflow-steps/ai">
