...
[Full reference →](/docs/reference/steps/agent)
...
[Full reference →](/docs/reference/steps/git)
...
[Full reference →](/docs/reference/steps/cli)
...
[Full reference →](/docs/reference/steps/artifact)
...
[Full reference →](/docs/reference/steps/annotation)
...
- [Step Types Reference](/docs/reference/steps) - Complete step documentation
