---
title: Agentcmd Workflows
description: Type-safe workflow SDK for AgentCmd powered by Inngest
---
...
Type-safe workflow SDK for <AgentCmd /> workflow engine powered by Inngest.

## Installation

```bash
npm install agentcmd-workflows
# or
pnpm add agentcmd-workflows
# or
yarn add agentcmd-workflows
```

## Quick Start

Create a workflow in your project's `.agent/workflows/definitions/` directory:
...
[Full reference →](/docs/reference/workflow-steps/agent)
...
[Full reference →](/docs/reference/workflow-steps/git)
...
[Full reference →](/docs/reference/workflow-steps/cli-step)
...
[Full reference →](/docs/reference/workflow-steps/artifact)
...
[Full reference →](/docs/reference/workflow-steps/annotation)
...
- [Workflow Concepts](/docs/concepts/workflows) - Understanding workflows
- [Step Types Reference](/docs/reference/workflow-steps) - Complete step documentation
