            ...
            <div>
              ...
              <ul className="mt-6 space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-300">Custom slash commands for YOUR team's processes</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="flex-shrink-0 mt-1">
                    <svg className="h-5 w-5 text-emerald-500" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-gray-300">Spec-driven development (generate → implement → review)</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="flex-shrink-0 mt-1">
                    <svg className="h-5 w-5 text-emerald-500" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-gray-300">Git workspace options (branches, worktrees, or current branch)</span>
                </li>
              </ul>
            </div>
            ...
            <div className="order-1 lg:order-2">
              ...
              <ul className="mt-6 space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-300">Multi-agent workflows (Claude + Codex + Gemini)</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="flex-shrink-0 mt-1">
                    <svg className="h-5 w-5 text-emerald-500" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-gray-300">Real-time streaming output</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="flex-shrink-0 mt-1">
                    <svg className="h-5 w-5 text-emerald-500" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-gray-300">Resumable sessions (never lose context)</span>
                </li>
              </ul>
            </div>
          </div>
            ...
            <div>
              ...
              <ul className="mt-6 space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-300">Branch creation and switching</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="flex-shrink-0 mt-1">
                    <svg className="h-5 w-5 text-emerald-500" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-gray-300">Commit changes with visual diff</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="flex-shrink-0 mt-1">
                    <svg className="h-5 w-5 text-emerald-500" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-gray-300">Integrated with workflows (auto-commit, auto-PR)</span>
                </li>
              </ul>
            </div>
            <div className="relative">
