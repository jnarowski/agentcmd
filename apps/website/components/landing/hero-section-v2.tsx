...
export default function HeroSectionV2() {
  ...
  return (
    ...
    >
      ...
      <div
        ref={ref}
        className="relative mt-[8rem] animate-fade-up opacity-0 [--animation-delay:400ms] [perspective:2000px] after:absolute after:inset-0 after:z-50 after:pointer-events-none after:[background:linear-gradient(to_top,var(--background)_30%,transparent)]"
      >
        <div
