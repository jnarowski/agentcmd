...
const tiles = [
  {
    icon: <Workflow className="size-full" />,
    bg: (
...
const Card = (card: { icon: React.ReactElement; bg: React.ReactElement }) => {
  const id = useId();
          ...
          <div className="relative flex w-full flex-col items-center justify-center overflow-hidden">
            ...
            <div className="absolute z-10">
              <div className="mx-auto size-24 rounded-[2rem] border bg-background/10 p-3 shadow-2xl backdrop-blur-md dark:bg-background/10 lg:size-32">
                <Workflow className="mx-auto size-16 text-foreground dark:text-foreground lg:size-24" />
              </div>
              <div className="z-10 mt-4 flex flex-col items-center text-center text-primary">
                <h1 className="text-3xl font-bold lg:text-4xl">
                  Ship features faster with AI workflows.
                </h1>
                <p className="mt-2">
